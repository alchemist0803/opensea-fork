...
import ArtGallery7 from "../explore/art-gallery7";
...
export default function Paragraph2() {
  ...
  return (
    <div className="w-full h-auto">
      ...
      <div className="relative grid grid-cols-1 gap-8 mx-8 sm:mx-10 lg:mx-[5vw]">
        {/* galleries */}
        ...
        {isLoading ? (
          ...
          <>
            {indexOfunsold > 2 ? (
              <ArtGallery7 galleries={galleries}></ArtGallery7>
            ) : (
