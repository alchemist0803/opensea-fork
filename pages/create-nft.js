                    ...
                    <div className='flex flex-col mx-8 sm:mx-12 lg:mx-[9vw] space-y-6 py-12 text-white dark:text-gray-800'>
                        ...
                        <div className='flex flex-col lg:flex-row items-center'>
                            ...
                            <div className='w-full lg:w-[40%] flex-none flex flex-col space-y-4'>
                                ...
                                <input className='text-[#B4BAEF] text-sm p-3.5 rounded-md border border-[#9FA4FF] bg-[#3a3a3a] dark:bg-white focus:outline-none focus:ring-2' placeholder='NFT Title' id="nft-title"
                              onChange = {e=>setNftFormInput({...nftFormInput,name:e.target.value})}
                                ...
                                <select className='text-[#B4BAEF] text-sm px-3.5 py-3 rounded-md border border-[#9FA4FF] bg-[#3a3a3a] dark:bg-white focus:outline-none focus:ring-2 appearance-none custom-select' placeholder='NFT Title' defaultValue={0} id="nft-category" onChange={e=>setNftFormInput({...nftFormInput,category:e.target.value})}>
                                ...
                                <div className='relative text-[#B4BAEF]'>
                                    <input className='w-full text-sm p-3.5 pr-16 rounded-md border border-[#9FA4FF] bg-[#3a3a3a] dark:bg-white focus:outline-none focus:ring-2' type="number" min={0}  placeholder='Price' id="nft-price"
                                                    onChange = {e=>setNftFormInput({...nftFormInput,price:e.target.value})} type="number">

                                                    </input>
                                    <p className='absolute top-1/2 right-8 -translate-y-1/2 text-sm'>ERC 20 Token</p>
                                    <FontAwesomeIcon icon={faEthereum} className='absolute top-1/2 right-4 -translate-y-1/2 text-sm' />
                                </div>
                                

                                
                            <textarea className='text-[#B4BAEF] text-sm p-3.5 rounded-md border border-[#9FA4FF] bg-[#3a3a3a] dark:bg-white focus:outline-none focus:ring-2' rows="6" placeholder='Desription'
                                            onChange ={e=>setNftFormInput({...nftFormInput,description:e.target.value})}

                            >

                                </textarea>
                                {isActive?                                <button className='rounded-full bg-gradient-to-b from-[#ffffff] to-[#ffffff] text-black text-base px-6 sm:px-10 py-2 shadow-md m-auto' id="btn-create-nft" onClick={createMarketItem}>Create</button>
:<button className='rounded-full bg-gradient-to-b from-[#ffffff] to-[#ffffff] text-black text-base px-6 sm:px-10 py-2 shadow-md m-auto' id="btn-create-nft" >{buttonTitle}</button>}
